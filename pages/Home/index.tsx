				...
				<div className="home-split">
					<div>
						<div className="block-table addresses-table">
							<span>Latest blocks <Link href="/blocks" className="viewmore">View more</Link></span>
							<div>
								<ReactTable
					...
					<div>
						<div className="block-table addresses-table">
							<span>Latest transactions <Link href="/transactions" className="viewmore">View more</Link></span>
							<div>
								<ReactTable
